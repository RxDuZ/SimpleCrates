...
class Crate {
    ...
    public function __construct(private string $name, private array $drops, private array $commands, private string $floatingText, private string $particleColor){
        $this->items = [];
    ...
    public function updateHologram(): void {
        ...
        if($cratePosition !== null){
            $up = ($pluginConfig["crates"]["preview-items"] ? 2 : 1.5); // Blocks to up
